...
require_once __DIR__."/config/parseJSON_tweets_config.php";
require_once __DIR__."/php/mysql_connection.php";
require_once __DIR__."/php/library_parseJSON_tweets.php";
require_once __DIR__."/config/parseJSON_MySQL_prepared_statements.php";
